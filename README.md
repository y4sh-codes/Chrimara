...
Chimera implements **Flow-Anchor Poisoning**, a novel clean-label attack targeting Flow-Matching Diffusion Transformers (DiTs). Unlike prior work (Nightshade, BadDiffusion) designed for U-Net LDMs, this attack exploits:
